...
import { Globe, Mail, Lock, ArrowRight, Eye, EyeOff, Shield, Sparkles, User, Phone, CheckCircle2 } from 'lucide-react'
...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      // Store user info for later use in consent & messaging
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 gradient-subtle">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSignUp} className="mt-6 space-y-4">
            ...
            <button type="submit" disabled={loading || success} className="w-full py-3.5 rounded-xl gradient-primary text-white font-semibold text-sm flex items-center justify-center gap-2 hover:shadow-xl hover:shadow-blue-500/25 transition-all btn-press disabled:opacity-70 mt-2">
